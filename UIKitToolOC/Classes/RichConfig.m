...
+ (NSMutableAttributedString *)getAttr:(NSString *)text
    ...
    [attr addAttribute:NSFontAttributeName value:(font == nil ? [UIFont systemFontOfSize:14 weight:(UIFontWeightMedium)]: font) range:range];
    [attr addAttribute:NSForegroundColorAttributeName value:(color == nil ? [UIColor blackColor]: color) range:range];
